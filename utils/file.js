...
/**
 * the module contains file utilities
 */
const fileUtils = {
  /**
  ...
  /**
   * gets list of file documents from database
   * to a parent id
   * @query {obj} query used to find file
   ...
   * @FOLDER_PATH {string} path to save file in the disk
  ...
  /**
   * Gets a files data from the database
   * @file {object} file whose data to obtain
   * @size {string} size for image file
